...
model = dict(
    ...
    init_cfg=dict(
        type='Pretrained',
        checkpoint=
        'pretrain/segmenter/segmenter_vit-b_mask_8x1_512x512_160k_ade20k_20220105_151706-bc533b08.pth'
    ))
dataset_type = 'ADE20KDataset'
data_root = '/common/users/dm1487/ade_small/ADEChallengeData2016'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        ...
        classes=('person', 'table', 'plant', 'chair', 'water', 'lamp',
                 'cushion', 'box', 'pillow', 'flower', 'book', 'computer',
                 'towel', 'bottle', 'plaything', 'bag', 'ball', 'food',
                 'monitor')),
    val=dict(
        type='ADE20KDataset',
        data_root='/common/users/dm1487/ade_small/ADEChallengeData2016',
...
log_level = 'INFO'
load_from = 'pretrain/segmenter/segmenter_vit-b_mask_8x1_512x512_160k_ade20k_20220105_151706-bc533b08.pth'
resume_from = None
workflow = [('train', 1)]
...
device = 'cuda'
seed = 42
work_dir = '/common/users/dm1487/segmentation_models/segmenter_mask_50k'
gpu_ids = [0]
