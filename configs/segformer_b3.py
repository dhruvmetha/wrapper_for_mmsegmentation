from .base_config import BaseModelConfig, CLASSES, PALETTE
import os

opj = lambda *args: os.path.join(*args)

CONFIG_FOLDER = '/common/home/dm1487/Spring22/robotics/segmentation/mmsegmentation/configs'
MODEL_CONFIG = opj(CONFIG_FOLDER, 'segformer/segformer_mit-b3_512x512_160k_ade20k.py')
...
LOAD_CKPT = 'pretrain/segformer_mit-b3_512x512_160k_ade20k_20220617_162254-3a4b7363.pth'
...
class Config(BaseConfig):
    ...
    class model_meta:
        ...
        save_path = opj(BASE_WORK_DIR, 'b3_longer_training', 'results')
        # load_ckpt = LOAD_CKPT
        classes = CLASSES
        palette = PALETTE
    ...
    class cfg:
        ...
        load_from = LOAD_CKPT
        device = 'cuda'
        work_dir = opj(BASE_WORK_DIR, 'b3_longer_training')
        seed = 0
        # gpu_ids = [0]
        # workflow = [('train', 1)]
        class model:
